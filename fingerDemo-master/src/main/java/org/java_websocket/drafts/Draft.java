...
public abstract class Draft {
	...
	public List<ByteBuffer> createHandshake( Handshakedata handshakedata, Role ownrole, boolean withcontent ) {
		...
		bui.append( "\r\n" );
		String fieldvalue = handshakedata.getFieldValue("Upgrade");
		bui.append( "Upgrade: " + fieldvalue );
		bui.append( "\r\n" );
		fieldvalue = handshakedata.getFieldValue("Connection");
		bui.append( "Connection: " + fieldvalue );
		bui.append( "\r\n" );
		fieldvalue = handshakedata.getFieldValue("Sec-WebSocket-Accept");
		bui.append( "Sec-WebSocket-Accept: " + fieldvalue );
		bui.append( "\r\n" );
